...
with st.sidebar:
    if st.button('Check Current Market Activity'):
        webbrowser.open_new_tab('https://www.nasdaq.com/market-activity/stocks/screener')
    ...
    with st.form(key = 'Form1',clear_on_submit=True):
        submitted = st.form_submit_button("Enter",on_click=get_save)
...
if submitted:
    ...
    try:
        with st.spinner('Loading.... Please Wait...'):
            ...
            data = yahoo_financials.get_historical_price_data(start_date='2000-01-01', end_date='2012-12-31', time_interval='daily')
            ...
            data_viz = yahoo_financials_viz.get_historical_price_data(start_date=start_viz, end_date=end_viz, time_interval=interval_viz)
        ...
        #Visualizations
        with st.spinner('Loading.... Please Wait...'):
            # Moving Averages plot of Closing Prices  
        ...
        with st.spinner('Loading.... Please Wait...'):
            #Daily Highs and Lows Candlestick Plot
        ...
        st.info('No Results Found. Please Check Your Input and Try Again.')
